...
{
    public interface IDanhMucSanPhamService : IService<DanhMucSanPham, DanhMucSanPhamViewModel>
    {
        //Task<ResponseEntity> CheckPass(NguoiDungViewModel model);

    }

    public class DanhMucSanPhamService : ServiceBase<DanhMucSanPham, DanhMucSanPhamViewModel>, IDanhMucSanPhamService
    {
        //private readonly INguoiDungRepository _nguoiDungRepository;

        public DanhMucSanPhamService(IDanhMucSanPhamRepository danhMucSanPhamRepository, IMapper mapper)
            : base(danhMucSanPhamRepository, mapper)
        {
        }
